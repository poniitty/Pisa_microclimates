...
#site 116 in 2020 data but not in 2021
all %>% filter(tomst_id == 94204755) # No such tomst_id in 2021 data, so it is fine


# For site 116 find 2020 data and copy to repository
...
# Copy site 116 data from last year data
f2[grepl("pisa/tomst/data_94204755_0.csv", f2)]
dir.create(paste0(getwd(), "/data/Pisa21/TOMST/116"))
file.copy(f2[grepl("/pisa/tomst/data_94204755_0.csv", f2)],
          paste0(getwd(), "/data/Pisa21/TOMST/116/data_94204755_0.csv"))
