...
office <- c(as_date(as_date(min(df$datetime)):as_date("2019-09-14")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-06-26")))
probls <- c()
hattu <- c()
...
office <- c(as_date(as_date(min(df$datetime)):as_date("2020-06-26")))
probls <- c(as_date(as_date("2021-06-01"):as_date("2021-10-05")))
hattu <- c()
